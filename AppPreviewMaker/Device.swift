...
enum Device: Int, Identifiable, CaseIterable {
    ...
    var icon: Image {
        switch self {
        case .iPhone15ProMax: return Image(systemName: "iphone.gen2")
    ...
    var image: Image {
        switch self {
        case .iPhone15ProMax: return Image(.iPhone15ProMax)
    ...
    var size: CGSize {
        switch self {
        case .iPhone15ProMax: return CGSize(width: 1452, height: 2940)
    ...
    var offset: CGPoint {
        switch self {
        case .iPhone15ProMax: return CGPoint(x: 81, y: 72)
    ...
    var radius: CGFloat {
        return self == .iPhone15ProMax ? 80 : 0
    }

    var scale: CGFloat {
        switch self {
        case .iPhone15ProMax: return 0.25
